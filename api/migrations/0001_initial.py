    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('meal_relation', models.CharField(blank=True, max_length=100, null=True)),
                ...
                ('medication', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='courses', to='api.medication')),
            ],
        ),
    ]
